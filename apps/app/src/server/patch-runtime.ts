...
import { PrismaPatchRepository, PostgresContentReader } from "@corely/modules-patches";

export function patchRuntime() {
  return { ...sourceRuntime(), patches: new PrismaPatchRepository(getPrisma()), reader: new PostgresContentReader() };
}
